...
namespace DelegateDemoMastek
{
    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            CalculatorDelegate demo3 = MinusNumbers; //step4 invoke delegate
            ...
            Console.WriteLine("-----------"); //Lambda Expression
                                              //merge Step2+3
                                              //(input param)=>expression CalculatorDelegate demo01 = (a, b) => a + b;
            result = demo01(2, 4);
            Console.WriteLine("Addition= " + result); CalculatorDelegate demo02 = (a, b) => a * b;
            result1 = demo02(2, 4);
            Console.WriteLine("Multiplication= " + result1); CalculatorDelegate demo03 = (a, b) => a - b;
            result2 = demo03(5, 2);
            Console.WriteLine("Substraction= " + result2); demo01 = (x, y) => x * y;
            result = demo01(12, 5); //Action/Action<T> //Func<> // Predicate
        }
    }
}
